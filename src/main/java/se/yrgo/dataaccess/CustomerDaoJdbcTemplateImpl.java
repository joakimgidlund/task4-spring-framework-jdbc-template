...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static String CREATE_CUSTOMER_SQL = "CREATE TABLE CUSTOMER (CUSTOMER_ID VARCHAR(255), COMPANY_NAME VARCHAR(255), EMAIL VARCHAR(255), TELEPHONE VARCHAR(20), NOTES VARCHAR(255))";
    private static String CREATE_CALL_TBL_SQL = "CREATE TABLE CALL_TBL (CALL_ID integer generated by default (start with 1), CUSTOMER_ID VARCHAR(5), TIME_AND_DATE DATE, NOTES VARCHAR(255))";
    ...
    private static String CUSTOMER_GET_FULL_DETAIL = "SELECT * FROM CUSTOMER AS CUST JOIN CALL_TBL AS C ON CUST.CUSTOMER_ID=C.CUSTOMER_ID WHERE CUSTOMER_ID=?";
    ...
    private void createTables() {
        try {
            ...
            this.template.update(CREATE_CALL_TBL_SQL);
        } catch(Exception ex) {
